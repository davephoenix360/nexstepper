...
export const STANDARD_EXPORT_NOTES = [
  'Generated by Nextep for the user named in `user.id`. This bundle is a self-contained snapshot of every Nextep-owned record associated with that user at `exportedAt`.',
